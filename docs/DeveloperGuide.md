...
1. Test case 1:
    ...
    1. Execute `edit 1 n/new name c/todo`<br>
       Expected: The app should response with "Please do not provide column in List view window"
...
1. Test case 1:
    ...
    1. Execute `addTag 1 nt/tag1` 
       Expected: The first bug has will have a new tag of tag1.
       Details of the bug is shown in the status message.
    ...
    1. Execute `addTag 1 nt/tag1 c/todo` 
       Expected: The app should response with "Please do not provide column in List view window"
